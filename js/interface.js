                ...
                html += `
                    <tr>
                        <td>
                            <div class="gig-rounded">
                                <div class="git-label-desc" title="${task.description}">
                                    <a class="links" href="https://toloka.yandex.com/task/${task.pools[0].id}?refUuid=${task.refUuid}" target="_blank">${task.title}</a>
                                </div>
                                <div>
                                    <!--
                        ...
                        <td class="gig-centered">
                            <input type="checkbox" class="gig-checkbox" id="field${count}">
                        </td>
                    </tr>
                `;
                count++;
